...
if __name__ == "__main__":
  ...
  if not tfvar_defaults['single_nat_gateway'] and tfvar_defaults['one_nat_gateway_per_az']:
    public_cidr_block01a_ngw_visible = True
  ...
  content = content.replace("%master_cidr_block%", tfvar_defaults['master_cidr_block'])
  content = content.replace("%public_tier_name%", tfvar_defaults['public_tier_name'])
  content = content.replace("%private01_tier_name%", tfvar_defaults['private01_tier_name'])
  content = content.replace("%private02_tier_name%", tfvar_defaults['private02_tier_name'])
  content = content.replace("%private03_tier_name%", tfvar_defaults['private03_tier_name'])
